...
public class DicionarioBack extends UnicastRemoteObject implements DicionarioInterface, CalculadoraInterface {

    public DicionarioBack() throws RemoteException {
        super();
    }
